...
export default function Layout({ children, home }) {
  return (
    <div className={[styles.container, akjcraggFont.className].join (' ')}>
      ...
      <link rel="apple-touch-icon"       href="/img/akjcragg-logo.png" sizes="180x180" />
      <link rel="icon"                   href="/img/akjcragg-logo.png" sizes="32x32" type="image/png" />
      <link rel="icon"                   href="/img/akjcragg-logo.png" sizes="16x16" type="image/png" />
      <link rel="mask-icon"              href="/img/akjcragg-logo.png" color="#563d7c" />
      <link rel="icon"                   href="/img/akjcragg-logo.png" />
      ...
      <meta name="twitter:image"        content="https://akjcragg.vercel.app/img/akjcragg-logo.png" />
      ...
      <meta property="og:image"            content="https://akjcragg.com/img/akjcragg-logo.png" />
      <meta property="og:image:secure_url" content="https://akjcragg.com/img/akjcragg-logo.png" />
